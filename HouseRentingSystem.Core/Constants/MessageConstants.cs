namespace HouseRentingSystem.Core.Constants
{
    public class MessageConstants
    {
		...
		public const string HouseTitleMinLenth = "You should have no rents to become an agent";
		public const string HouseTitleMaxLenth = "You should have no rents to become an agent";
	}
}
